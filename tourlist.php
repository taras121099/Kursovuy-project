...
<H1> Cписок доступних турів.</H1>
<h2>Кожний тур розрахований на 10 днів</h2>
...
$sql = "SELECT Name, DateVidprav, DatePovern, Price FROM tours";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo  "Назва тура: " . $row["Name"].    "<br> Дата відправлення: " . $row["DateVidprav"]. " <br> Дата повернення: " . $row["DatePovern"]. " <br>Ціна: " . $row["Price"]. "<br>";
